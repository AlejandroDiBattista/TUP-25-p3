...
//AGREGA LOS PRODUCTOS PUTA
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        new Producto { ProductoId = 1, Titulo = "Baggie Crema", Detalle = "Pantalon de algodon con estampado.", Valor = 35200, CantidadDisponible = 12, ImagenUrl = "img.catalogo/baggie_blanco.jpeg" },
        ...
        new Producto { ProductoId = 6, Titulo = "Camisa negra", Detalle = "Camisa mangas cortas", Valor = 37000, CantidadDisponible = 15, ImagenUrl = "img.catalogo/camisa.jpeg" },
