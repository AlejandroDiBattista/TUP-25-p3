...
class Program
{
    ...
    // terminan las opvcioes del menu 
    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            if (opcion == "6")
            {
                programa.GuardarEnArchivo();
                break;
            }
            else if (opcion == "1") programa.AgregarContacto();
            else if (opcion == "2") programa.ModificarContacto();
            else if (opcion == "3") programa.EliminarContacto();
            else if (opcion == "4") programa.ListarContactos();
            else if (opcion == "5") programa.BuscarContacto();
